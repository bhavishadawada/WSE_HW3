...
public abstract class Ranker {
	...
	/*public void psuedoRelevanceCalc(QueryPhrase query, int numResults , int numTerms){
		...
		List<Map.Entry<String, Integer>> entries = new ArrayList<Map.Entry<Integer, Integer>>(frequencyMap.entrySet());
		Collections.sort(entries, new Comparator<Map.Entry<Integer, Integer>>() {
			public int compare(
					Map.Entry<String, Integer> entry1, Map.Entry<Integer, Integer> entry2) {
